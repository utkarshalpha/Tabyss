...
document.getElementById("savedDashboard").addEventListener("click", () =>
  chrome.tabs.create({ url: chrome.runtime.getURL("dashboard.html") })
);
document.getElementById("savedSettings").addEventListener("click", () => chrome.runtime.openOptionsPage());
